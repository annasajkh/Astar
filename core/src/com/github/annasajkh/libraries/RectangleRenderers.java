...
public class RectangleRenderers extends ShapeRenderers
{
    ...
    public void renderAll(List<? extends Rectangle> rectangles)
    {
        if (filled)
        {
        ...
        for (Rectangle rectangle : rectangles)
        {
            ...
            if (rectangle.centered)
            {
                ...
                {
                    shapeRenderer.rect(rectangle.position.x - rectangle.size.width / 2, rectangle.position.y -
                                                                                        rectangle.size.height / 2,
                                       rectangle.size.width /
                                       2, rectangle.size.height /
                                          2, rectangle.size.width, rectangle.size.height, 1, 1, rectangle.rotation);
                }
            ...
            else
            {
                if (!rectangle.dontRender)
                {
                    shapeRenderer.rect(rectangle.position.x, rectangle.position.y, rectangle.size.width /
                                                                                   2, rectangle.size.height /
                                                                                      2, rectangle.size.width, rectangle.size.height, 1, 1, rectangle.rotation);
                }
